const Testimonials = () => {
    return (
      <div>
        <div class="w-full bg-[#DAD7CD] border-t border-b border-gray-200 px-5 py-16 md:py-24 text-gray-800">
            <div class="w-full max-w-6xl mx-auto">
                <div class="text-center max-w-xl mx-auto">
                    <h1 class="text-6xl md:text-7xl font-bold mb-5 ">What people <br /> are saying.</h1>
                ...
                <div class="-mx-3 md:flex items-start">
                    <div class="px-3 md:w-1/3">
                        <div class="w-full mx-auto rounded-lg bg-[#b1c390] border border-gray-200 p-5 text-[#696969] font-light mb-6">
